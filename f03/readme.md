...
Nesta fase foram estudados os fundamentos de redes de computadores, protocolos de comunicação, análise de tráfego e técnicas de reconhecimento utilizadas em ambientes de Cybersecurity.
O objetivo foi compreender como os dispositivos se comunicam, como os dados trafegam pela rede e como identificar informações relevantes utilizando ferramentas empregadas por profissionais de segurança.
...
* Entendimento da comunicação em redes.
* Leitura e interpretação de protocolos.
...
* Analisar resultados de varreduras Nmap.
* Extrair informações em capturas de rede (PCAP).
* Investigar tráfego HTTP em texto puro.
* Analisar consultas DNS utilizadas para exfiltração de dados.
* Utilizar Wireshark e Tshark para análise forense de rede.
